...
Bullet::Bullet(Position position, Direction direction, const Map& map)
  : m_position{ position }, m_direction{ direction }, m_map{ map } {
  m_image.loadFromFile(data::assetsDir / "Bullet/bullet.png");
...
const sf::Sprite& Bullet::GetSprite() const noexcept { return m_sprite; }
...
bool Bullet::IsAlive() const noexcept { return m_isAlive; }
