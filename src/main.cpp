...
int main() {
  try {
    sf::RenderWindow window{ sf::VideoMode{ 800, 600 }, "Giga Tank Game" };
    window.setFramerateLimit(60);

    Map map{};
    Tank tank{ true, data::assetsDir / "Tanks/tank_bigRed.png", map };
    View view{ map };
    ...
    while (window.isOpen()) {
      ...
      if (sf::Keyboard::isKeyPressed(sf::Keyboard::Space)) tank.Shoot();
